...
/*
 * FontWaterFall: Display a typographic waterfall chart, with and without
...
class FontWaterFall extends JFrame
{
    ...
    FontWaterFall(String fn, String st, int s1, int s2, int si,
	...
	sizeInc = si;
	renderingHints = hints;
	getContentPane().add(new FontWaterFallComponent());
	pack();
	setVisible(true);
	incFrameCount();
    ...
    private class FontWaterFallComponent extends JComponent
    {
	FontWaterFallComponent()
	{
	...
	if (argv.length != 5)
	{
	    System.err.println("Usage: FontWaterFall <font> <style> <min_size> " +
			       "<max_size> <increment>");
	    System.exit(1);
	}
	try
	...
	{
	    System.err.println("Usage: FontWaterFall <font> <min_size> " +
			       "<max_size> <increment>");
	    System.exit(1);
	}
	...
	new FontWaterFall(fontname, style, size1, size2, sizeInc, null);
	...
	new FontWaterFall(fontname, style, size1, size2, sizeInc, renderingHints);
    }
}
